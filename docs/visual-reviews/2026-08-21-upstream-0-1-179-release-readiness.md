...
<!-- visual-review-manifest
{
  ...
  "routes_or_surfaces": ["/models", "/models/:family", "/pricing/:family compatibility redirect", "/admin/accounts", "/admin/channels", "/admin/channel-monitor", "/admin/subscriptions", "user monitor detail"],
