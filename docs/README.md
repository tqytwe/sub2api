...
| [前端设计系统与视觉开发规范](./FRONTEND_DESIGN_SYSTEM.md) | `active` | 页面框架、图标、视觉 token、交互状态和截图门禁 | 前端维护者 | 2026-07-21 |
...
| [v0.1.182 P0 文档与订阅契约](./V182_P0_DOCS_SUBSCRIPTIONS_CONTRACT.md) | `proposal` | 原生文档路由、嵌入安全、语言切换、订阅进度与生产验收边界 | 平台维护者 | 2026-08-31 |
...
| [插件开发指南](./PLUGIN_DEVELOPMENT.md) | `reference` | 上游插件包、运行时和 UI bridge 开发约束 | 插件维护者 | 2026-08-25 |
| [State Kit 插件集成边界](./STATE_KIT_PLUGIN_INTEGRATION.md) | `reference` | v0.2.7 官方插件协议、宿主边界和双语验收要求 | 插件维护者 | 2026-09-19 |
