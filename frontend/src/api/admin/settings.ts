...
export interface SystemSettings {
  ...
  play_checkin_daily_reward: number;
  play_arena_enabled: boolean;
  play_blindbox_enabled: boolean;
  play_blindbox_cost: number;
  play_blindbox_daily_limit: number;
  play_quiz_enabled: boolean;
  play_quiz_reward_per_correct: number;
  play_quiz_questions_per_day: number;
