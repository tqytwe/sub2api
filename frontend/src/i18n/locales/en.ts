...
const messages = {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      restoreDailyCardQuotaConfirm: "Compensate the current daily card for '{user}'? This resets used quota on this card to zero.",
      dailyCardQuotaRestored: 'Current daily card restored',
