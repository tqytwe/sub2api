...
export default {
  ...
  admin: {
    ...
    modelCatalog: {
      ...
      syncResult: 'Updated {updated} channel prices; discovered {discovered} new models (added to discovery pool)',
      ...
      fillLiteLLM: 'Fill from LiteLLM',
      fillDone: 'Updated {n} prices',
