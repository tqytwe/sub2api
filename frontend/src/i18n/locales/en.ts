...
const messages = {
  ...
  admin: {
    ...
    modelCatalog: {
      title: 'Model Catalog',
      description: 'Manage official reference prices, guest/signed-in visibility, and model display groups. Paid display prices use real channel prices and group multipliers and are storefront-only.',
      searchPlaceholder: 'Search models…',
