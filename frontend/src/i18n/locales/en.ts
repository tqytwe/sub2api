  ...
  admin: {
    ...
    funds: {
      ...
      errors: {
        ...
        FUND_INVALID_AMOUNT: 'Amount must be a positive whole number',
        FUND_INSUFFICIENT_REFUNDABLE: 'Insufficient refundable recharge balance',
