...
const messages = {
  ...
  admin: {
    ...
    subscriptions: {
      ...
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
      releaseDailyCardHolds: 'Release Holds',
      releaseDailyCardHoldsTitle: 'Release Daily Card Holds',
      releaseDailyCardHoldsConfirm: "Release reserved holds on the current daily card for '{user}'? This only releases reserved holds and does not reset used quota.",
      dailyCardHoldsReleased: 'Released {count} daily card hold(s)',
      failedToReleaseDailyCardHolds: 'Failed to release daily card holds',
      restoreDailyCardQuota: 'Compensate',
      restoreDailyCardQuotaTitle: 'Compensate Current Daily Card',
      restoreDailyCardQuotaConfirm: "Compensate the current daily card for '{user}'? This releases holds and resets used quota on this card to zero.",
      dailyCardQuotaRestored: 'Current daily card restored; released {count} hold(s)',
      failedToRestoreDailyCardQuota: 'Failed to compensate daily card',
  ...
  userSubscriptions: {
    ...
    dailyCardQueued: '{count} more daily card(s) queued',
    dailyCardExhausted: 'This daily card is exhausted',
    dailyCardExpired: 'This daily card has expired',
  ...
  payment: {
    ...
    admin: {
      ...
      quotaModeRecurring: 'Recurring quota',
      quotaModeOneTime: 'One-time quota',
      quotaLimitUsd: 'Total quota (USD)',
