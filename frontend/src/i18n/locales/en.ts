...
const messages = {
  ...
  admin: {
    ...
    withdrawals: {
      ...
      recomputeExistingMismatchHint: 'Withdrawals cannot be enabled yet. Review the page anomalies, then run the check again.',
      ...
      recomputeAnomalyCodes: {
        ...
        existing_entitlements_mismatch: 'Existing entitlement batches do not match this recompute result. Continue manual review.',
