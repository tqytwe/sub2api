...
export default {
  ...
  admin: {
    ...
    modelCatalog: {
      title: 'Model Catalog',
      description: 'Control which models guests and signed-in users see, sort order, and reference prices. Effective signed-in prices still come from channel pricing × group multiplier.',
      ...
      columns: {
        model: 'Model',
        platform: 'Platform',
        officialInput: 'AIHubMix official in',
        officialOutput: 'AIHubMix official out',
        channelInput: 'Billing base in',
        channelOutput: 'Billing base out',
        input: 'Site reference in',
        output: 'Site reference out',
      ...
      fields: {
        ...
        priceMode: 'Site reference price',
        ...
        siteInputPerMillion: 'Site input / 1M tokens (USD)',
        siteOutputPerMillion: 'Site output / 1M tokens (USD)',
    ...
    settings: {
      ...
      features: {
        ...
        play: {
          ...
          publicModelsEnabledHint: 'Guests can browse official reference pricing at /models.',
