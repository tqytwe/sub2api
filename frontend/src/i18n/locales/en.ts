...
const messages = {
  ...
  keys: {
    ...
    speedTest: {
      ...
      prompts: {
        concise: 'Describe edge computing in one sentence.',
        reasoning: 'List three ways to judge whether API latency is stable.',
        translation: 'Translate fast and reliable model gateway into Chinese.',
        summary: 'Summarize the value of real-time streaming responses in under 50 words.',
        code: 'Write a JavaScript function that returns the largest value in an array.',
      },
    },
    ...
    ccSwitchNotSupportedForPlatform:
      'This group platform cannot be imported into CC-Switch. Use “Use Key” for the platform-specific setup.',
    ccsClientSelect: {
      title: 'Select Client',
  ...
  affiliate: {
    ...
    teamLinkHint: 'Link includes your affiliate ref and squad code {code} — new users join your squad after signup.',
    copyCode: 'Copy Code',
    copyLink: 'Copy Link',
    ...
    campaign: {
      ...
      rule: 'An invite counts after the invitee reaches {pay} net paid and {spend} actual usage.', windows: 'Enrollment closes: {registration}; qualification closes: {qualification}; claim closes: {claim}', claimDeadline: 'Claim deadline: {date}', enroll: 'Enroll', enrolled: 'Campaign enrollment completed', enrollFailed: 'Campaign enrollment failed',
    ...
    growth: { eyebrow: 'New-user growth reward', title: 'Growth activity for invited users', description: 'Users who join through an invite link earn milestone rewards according to the activity configuration.', inviteOnly: 'Invite attribution required', metricRecharge: 'Measured by cumulative net recharge', metricConsumption: 'Measured by verified paid consumption', fundingConflict: 'A non-recharge balance credit was detected during this activity. This period\'s consumption does not count toward growth rewards.', rebatePolicy: 'Normal 10% rebate: {policy}', deadline: 'Activity ends: {date}', progress: 'My cumulative progress', tier: 'Reach {amount}', claim: 'Claim milestone', claimed: 'Growth reward claimed', claimFailed: 'Failed to claim growth reward' },
    invitees: {
      title: 'Invited Users',
  ...
  admin: {
    ...
    funds: {
      ...
      errors: {
        STEP_UP_REQUIRED: 'Complete admin TOTP verification first',
        STEP_UP_TOTP_NOT_ENABLED: 'This admin account has not enabled TOTP. Enable two-factor verification first.',
        STEP_UP_ADMIN_API_KEY_FORBIDDEN: 'Admin API keys cannot perform fund operations. Sign in with an admin account.',
        STEP_UP_UNAVAILABLE: 'Step-up verification is temporarily unavailable. Try again later.',
        UNAUTHORIZED: 'Admin session expired. Sign in again.',
        FUND_MANAGEMENT_UNAVAILABLE: 'Fund management service is unavailable',
        FUND_INVALID_INPUT: 'Fund operation parameters are invalid. Check user, reason, and admin session.',
        FUND_INVALID_AMOUNT: 'Amount must be greater than 0 with up to 8 decimal places',
        FUND_INSUFFICIENT_REFUNDABLE: 'Insufficient refundable recharge balance',
        FUND_REFUND_IN_PROGRESS: 'This user already has an in-progress recharge return request',
        FUND_REFUND_ACCOUNT_REQUIRED: 'The user has not set a payout account',
        FUND_REFUND_NOT_FOUND: 'Recharge return request not found',
        FUND_REFUND_INVALID_STATUS: 'This status does not allow the operation',
        FUND_CLASSIFICATION_NOTHING_TO_DO: 'Select at least one historical gift candidate to review',
    ...
    withdrawals: {
      ...
      settingsSaveFailed: 'Failed to save withdrawal rules',
      ...
      recomputeExistingVerified: 'Existing entitlements verified',
      recomputeExistingVerifiedHint: 'No duplicate entitlement batches will be inserted. Writing the result only updates the review status and withdrawable balance.',
      recomputeExistingMismatch: 'Existing entitlements do not match',
      recomputeExistingMismatchHint: 'Ledger balance is not the same as withdrawable amount. Withdrawals cannot be enabled yet; review the page anomalies, then run the check again.',
      ...
      recomputeCheckReady: 'Review check passed',
      recomputeCheckNeedsReview: 'Review check found items that need manual review',
      recomputeExecutedReady: 'Review result written. This user is ready.',
      recomputeExecutedNeedsReview: 'Review result recorded, but this user still needs manual review.',
      recomputeFailed: 'Withdrawable review failed',
      recomputeModes: {
        dry_run: 'Check only',
        execute: 'Written',
      ...
      recomputeSources: {
        ...
        arena_daily_settlement: 'Farm daily reward',
        arena_settlement: 'Farm monthly reward',
        team_shared_reward: 'Agent Team shared reward',
        unknown: 'Unknown source',
      },
      recomputeAnomalyCodes: {
        existing_entitlements: 'Existing entitlement batches are present. Run the review check to confirm whether they match this result.',
        existing_entitlements_mismatch: 'Existing entitlement batches do not match this recompute result. Review the amounts and sources shown on this page first.',
        transaction_confidence: 'Transaction #{transaction_id} does not have high-confidence ledger evidence.',
        missing_balance_before: 'Transaction #{transaction_id} is missing a reliable balance-before snapshot.',
        restore_mismatch: 'Transaction #{transaction_id} cannot fully restore the original entitlement batches.',
        entitlement_exceeds_balance: 'Computed entitlements exceed the current balance.',
        replay_balance_mismatch: 'Ledger replay balance {ledger_balance} does not match current user balance {user_balance}.',
      ...
      batchSettingsSaveFailed: 'Batch save failed',
      ...
      errors: {
        ...
        WITHDRAWAL_INSUFFICIENT_WITHDRAWABLE: 'Insufficient withdrawable balance',
        WITHDRAWAL_DAILY_LIMIT_EXCEEDED: 'Shanghai daily withdrawal limit exceeded',
        WITHDRAWAL_MINIMUM_AMOUNT: 'Amount is below the minimum withdrawal',
        WITHDRAWAL_IN_PROGRESS: 'This user already has an in-progress withdrawal',
        WITHDRAWAL_ACCOUNT_REQUIRED: 'The user has not set a payout account',
        WITHDRAWAL_NOT_FOUND: 'Withdrawal request not found',
        WITHDRAWAL_INVALID_STATUS: 'This status does not allow the operation',
        WITHDRAWAL_SELF_REVIEW_FORBIDDEN: 'You cannot review your own withdrawal',
        WITHDRAWAL_USER_NOT_READY: 'This user has not passed withdrawable recomputation review',
        WITHDRAWAL_ACCOUNT_ENCRYPTION: 'Payout details encryption or decryption failed',
        USER_NOT_FOUND: 'User not found',
        BALANCE_LEDGER_UNAVAILABLE: 'Balance ledger service is unavailable',
        STEP_UP_REQUIRED: 'Complete admin TOTP verification first',
        ADMIN_API_KEY_FORBIDDEN: 'Admin API keys cannot perform this operation',
      },
    },
    // Dashboard
    dashboard: {
    ...
    users: {
      ...
      bulkActions: {
        ...
        stepUpRequired: 'A recent administrator TOTP verification is required before execution.',
        ...
        result: {
          completed: 'Batch action completed',
          partial: 'Batch action partially completed',
      ...
      // Balance Flow
      balanceHistory: 'Balance Flow',
      balanceHistoryTip: 'Click to open balance flow',
      columnAlwaysVisible: 'This column is always visible',
      ...
      platformOther: 'Other',
      balanceHistoryTitle: 'User Balance Flow',
      noBalanceHistory: 'No balance flow records found',
      allTypes: 'All Types',
      typePaymentRecharge: 'Payment Recharge',
      typeOfflineRecharge: 'Offline Recharge',
      typeBalance: 'Redeem Recharge',
      typeAffiliateBalance: 'Affiliate Transfer',
      typeAdminBalance: 'Admin Adjustment',
      typeOpsGift: 'Admin Gift',
      typeSignupGift: 'Signup Gift',
      typeAuthFirstBindGift: 'Auth First-bind Gift',
      typeCompensation: 'Compensation Gift',
      typeCheckin: 'Check-in',
      typeCheckinMakeup: 'Check-in Makeup',
      typeCheckinMilestone: 'Check-in Milestone',
      typeQuiz: 'Quiz',
      typeBlindbox: 'Blindbox',
      typeTeamSharedReward: 'Team Shared Reward',
      typeArenaSettlement: 'Arena Settlement',
      typeArenaDailySettlement: 'Daily Arena Settlement',
      typeUsageCharge: 'API Usage Charge',
      typeImageBalanceHold: 'Image Balance Hold',
      typeImageBalanceCapture: 'Image Charge Settlement',
      typeImageBalanceRelease: 'Image Hold Release',
      typeImageTask: 'Image Task',
      typeRefund: 'Refund Deduction',
      typeReversal: 'Reversal',
      typeFundRefundSubmit: 'Recharge Return Request',
      typeFundRefundCancel: 'Recharge Return Canceled',
      typeFundRefundReject: 'Recharge Return Rejected',
      typeFundRefundPaid: 'Recharge Return Paid',
      typePromoBonus: 'Promo Bonus',
      typeConcurrency: 'Concurrency (Redeem)',
      typeAdminConcurrency: 'Concurrency (Admin)',
      typeSubscription: 'Subscription',
      typeWithdrawalSubmit: 'Withdrawal Request',
      typeWithdrawalCancel: 'Withdrawal Canceled',
      typeWithdrawalReject: 'Withdrawal Rejected',
      typeWithdrawalPaid: 'Withdrawal Paid',
      frozenBalance: 'Frozen Balance',
      flowTotalIn: 'Total In',
      flowTotalOut: 'Total Out',
      flowNetDelta: 'Net Delta',
      flowRows: 'Rows',
      flowColumnTime: 'Time',
      flowColumnType: 'Type',
      flowColumnAmount: 'Amount',
      flowColumnBalance: 'Before/After',
      flowColumnSource: 'Related Object',
      flowColumnActor: 'Actor',
      flowColumnNotes: 'Notes/Details',
      flowDetails: 'Details',
      ...
      billingSurchargeMode_none: 'None',
      billingSurchargeMode_percent_on_charged_cost: 'Percent of charged cost',
      billingSurchargeMode_additive_multiplier: 'Additive multiplier',
      flowMetadata: {
        ...
        billing_surcharge_cost: 'Surcharge',
        billing_surcharge_mode: 'Surcharge mode',
        billing_surcharge_value: 'Surcharge value',
      ...
      flowRelatedObject: 'Related Object',
      flowSource: 'Source',
      flowReference: 'Reference',
      flowSourceBalanceTransactions: 'Balance Flow',
      flowSourcePaymentOrders: 'Payment Order',
      flowSourceRedeemCodes: 'Redeem Code',
      flowSourcePlayRewards: 'Play Reward',
      flowSourceBlindboxOpen: 'Blindbox Open',
      flowSourcePromoCodeUsages: 'Promo Code Usage',
      flowSourceUsageLogs: 'Usage Log',
      flowSourcePaymentAuditLogs: 'Payment Audit',
      flowSourceFundRefundRequest: 'Recharge Return Request',
      flowSourceWithdrawalRequest: 'Withdrawal Request',
      flowDescriptionOpsGift: 'Admin gift balance',
      flowDescriptionOfflineRecharge: 'Offline recharge confirmed',
      flowDescriptionFundRefundSubmit: 'Recharge return request submitted',
      flowDescriptionFundRefundPaid: 'Recharge return marked paid',
      flowDescriptionFundRefundRestored: 'Recharge return funds restored',
      flowDescriptionWithdrawalSubmit: 'Withdrawal request submitted',
      flowDescriptionWithdrawalRestored: 'Withdrawal funds restored',
      flowDescriptionWithdrawalPaid: 'Withdrawal marked paid',
      actor_system: 'System',
      actor_admin: 'Admin',
      actor_user: 'User',
      ...
      reconcileBalance: 'Reconcile',
      ledgerBalanceSum: 'Ledger Balance',
      ledgerFrozenSum: 'Ledger Frozen',
      balanceDifference: 'Balance Diff',
      frozenDifference: 'Frozen Diff',
      subscriptionValidity: 'Validity',
      subscriptionOrder: 'Order',
      subscriptionPayment: 'Payment',
      subscriptionPaidAt: 'Paid at',
      subscriptionDays: '{days} days',
      failedToLoadBalanceHistory: 'Failed to load balance flow',
      createdAt: 'Created',
    ...
    modelCatalog: {
      ...
      batchMultiply: 'Batch ×{mult}',
      batchApplyMultiplier: 'Apply official × multiplier',
      batchSetGroups: 'Set groups',
      batchGroupsTitle: 'Set signed-in pricing groups',
      groupLoadFailed: 'Failed to load groups',
      groupSelectRequired: 'Select at least one group',
      ...
      columns: {
        ...
        channelInput: 'Channel override in',
        channelOutput: 'Channel override out',
        input: 'Site base in',
        output: 'Site base out',
      ...
      fields: {
        ...
        priceMode: 'Site base price',
        priceModeManual: 'Manual prices',
        priceModeMultiplier: 'Official price × site multiplier',
        multiplier: 'Site multiplier',
        importMultiplier: 'Import multiplier',
        officialCacheRead: 'Official cache read',
        officialCacheWrite: 'Official cache write',
        siteInputPerMillion: 'Site base input / 1M tokens (USD)',
        siteOutputPerMillion: 'Site base output / 1M tokens (USD)',
        siteCacheReadPerMillion: 'Site cache read / 1M tokens (USD)',
        siteCacheWritePerMillion: 'Site cache write / 1M tokens (USD)',
      },
    },
    ...
    accounts: {
      ...
      upstreamBilling: {
        ...
        autoProbeHint: 'When enabled, this account is queried on the global probe interval. No probe runs when the global switch is off.',
        ...
        userRate: 'User-specific rate: {value}x',
    ...
    settings: {
      ...
      features: {
        ...
        play: {
          ...
          arenaEnabled: 'Token farm (arena)',
          arenaEnabledHint: 'Monthly token usage leaderboard at /arena.',
          blindboxEnabled: 'Blind box',
          blindboxEnabledHint: 'Balance-based blind box opens at /blindbox.',
          blindboxCost: 'Cost per open (balance)',
          blindboxDailyLimit: 'Daily open limit per user',
          quizEnabled: 'Quiz quest',
          quizEnabledHint: 'Daily quiz at /quiz-quest.',
          quizRewardPerCorrect: 'Balance branch reward per correct answer after quiz submission',
          quizQuestionsPerDay: 'Questions per daily quiz',
          agentTeamEnabled: 'Agent Team',
          agentTeamEnabledHint: 'Squad creation and invites at /agent-team.',
        },
        affiliate: {
      ...
      payment: {
        ...
        field_displayMerchantName: 'Checkout merchant display name',
        ...
        field_easypayApiBaseHint: 'For KyrenPay Epay compatibility, use https://api.kyrenpay.com/epay; do not enter the PID/merchant ID here. For other EasyPay providers, enter their API base URL.',
        field_displayMerchantNameHint: 'Optional. Shown on the KyrenPay checkout page and sent as display_merchant_name; leave empty to let the upstream fall back to merchant profile or login email.',
        field_paymentCurrencyHint: 'Default is CNY. Stripe, Airwallex, and EasyPay providers that support money_type can choose HKD, USD, or another listed currency supported by the account; WeChat Pay and Alipay remain CNY.',
  ...
  payment: {
    ...
    errors: {
      ...
      mobilePaymentFallbackToQrCouponHeld: 'The flow has switched to QR payment. To avoid redeeming a coupon twice, the coupon is not applied to this QR order and will return after the cancelled order is confirmed unpaid.',
      COUPON_NOT_FOUND: 'The selected coupon no longer exists or is unavailable. Choose another coupon.',
      COUPON_NOT_AVAILABLE: 'The selected coupon is processing another order or has already been used. Choose another coupon.',
      COUPON_EXPIRED: 'The selected coupon has expired. Choose another coupon.',
      COUPON_TERMS_INVALID: 'The selected coupon rules changed and it can no longer be used. Choose another coupon.',
      COUPON_SCOPE_MISMATCH: 'The selected coupon does not apply to this order.',
      COUPON_MINIMUM_NOT_MET: 'This order does not meet the coupon minimum.',
      COUPON_PLAN_MISMATCH: 'The selected coupon does not apply to this subscription plan.',
      COUPON_CURRENCY_MISMATCH: 'The selected coupon does not apply to this payment currency.',
      COUPON_QUOTE_CHANGED: 'The coupon quote changed. Select the coupon again before paying.',
      COUPON_SERVICE_UNAVAILABLE: 'Coupon service is temporarily unavailable. Please try again later.',
      INVALID_USER_COUPON_ID: 'Coupon details are invalid. Choose the coupon again.',
      INVALID_COUPON_ORDER: 'Coupon order details are invalid. Choose the coupon again and retry.',
      INVALID_COUPON_SETTLEMENT: 'Coupon pricing could not be calculated. Choose the coupon again and retry.',
    ...
    planShelf: {
      ...
      summary: '{platform} / {category}: {count} plans, showing {shown}',
      empty: 'No {category} plans under {platform}',
      expandAll: 'Show all {count} plans',
      reset: 'Reset filters',
