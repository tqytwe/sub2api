    ...
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          ...
          enabled: '启用模型广场',
          enabledHint: '开启后顶栏显示入口，页面可通过 /catalog 独立访问。',
      ...
      payment: {
        ...
        bepusdtManualRefundHint: '不支持自动退款；链上退款需人工处理。',
        typeDisabled: '类型已禁用',
        ...
        field_bepusdtApiBaseHint: '填写 BEpusdt 的公开根地址，例如 https://bepusdt.example.com；不要附加 /api 或 /pay。后端会传入不可修改的 CNY 订单金额，由 BEpusdt 锁定 USDT 实时报价；具体网络在 BEpusdt 收银台按已启用钱包选择。',
