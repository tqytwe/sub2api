export default {
    ...
    dashboard: {
      ...
      viewAllUsage: '查看全部',
      quickActions: '快捷操作',
      surchargeIncome: '手续费收入',
      todaySurcharge: '今日手续费',
      rangeSurcharge: '筛选范围',
      totalSurcharge: '累计手续费',
      surchargeRequests: '明细数',
      surchargeTime: '时间',
      surchargeUser: '用户 / Key',
      surchargeBase: '原始扣费',
      surchargeFee: '手续费',
      surchargeBilled: '实际扣款',
      noSurchargeRecords: '暂无手续费明细',
      surchargePageInfo: '第 {page} / {pages} 页',
      prevPage: '上一页',
      nextPage: '下一页',
      manageUsers: '管理用户',
