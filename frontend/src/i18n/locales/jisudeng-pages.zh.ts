...
export const jisudengPagesZh = {
  ...
  arena: {
	...
	participantCount: '当前有 {count} 位真实参与者',
	newcomerRank: '新秀榜第 {rank} 名',
    rpg: {
      season: '赛季',
      level: 'Lv.{level}',
      farmer: '耕作者',
  ...
  agentTeam: {
	...
	requestSent: '加入申请已发送',
	transferRequired: '请先将队长转让给其他成员',
	levelLabel: '小队等级',
	requestsLabel: '本月有效请求',
	activeDaysLabel: '活跃天数',
	weeklyMission: '本周共同任务',
	weeklyProgress: '{tokens}/{tokenTarget} Token · {requests}/{requestTarget} 次请求',
	transferCaptain: '转让队长',
	removeMember: '移除',
	joinRequestsTitle: '加入申请',
	approve: '通过',
	reject: '拒绝',
	activityTitle: '小队真实活动',
	activityEmpty: '完成真实任务后，活动会显示在这里。',
	leaveTeam: '退出小队',
	discoverTitle: '发现公开小队',
	discoveryStats: '{members}/{max} 人 · 本月 {requests} 次请求',
	requestJoin: '申请加入',
	activity: {
	  team_created: '{actor} 创建了小队',
	  team_joined: '{actor} 加入了小队',
	  usage_day: '{actor} 完成了真实 API 调用',
	  blindbox_opened: '{actor} 获得了盲盒奖励',
	  weekly_mission_completed: '{actor} 完成了本周共同任务'
	},
  },
  playHub: {
    eyebrow: '增长福利',
