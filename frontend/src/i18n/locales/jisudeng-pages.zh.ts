...
export const jisudengPagesZh = {
  ...
  models: {
    backHome: '← 返回首页',
    title: '模型与价格',
    subtitle: '官方原价与站内参考价（USD / 百万 token）— 游客可见管理员勾选的营销模型',
    subtitleAuth: '登录可见模型与本站参考价；已配置计费渠道时同时显示您的实付价（USD / 百万 token）',
    ...
    backDashboard: '← 返回仪表盘',
    priceUnitNote: '价格为美元/百万 token（1M tokens）。登录后「实付价」= 渠道价 × 您所在分组倍率。',
    columns: {
      model: '模型',
      platform: '平台',
      channel: '渠道',
