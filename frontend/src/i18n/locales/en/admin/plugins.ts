export default {
  plugins: {
    ...
    compatibleMessage: 'The plugin declares this Sub2API version as tested.',
    untestedMessage: 'The version range is compatible, but this Sub2API version is not declared as tested.',
    incompatibleMessage: 'Sub2API {current} does not meet the plugin requirement {required}.',
    runtimeReady: 'Plugin process is running.',
    runtimeUnavailable: 'Plugin process is currently unavailable.',
    runtimeError: 'Plugin runtime failed. Check the server logs or run the test again.',
    enabled: 'Enabled',
    disabled: 'Disabled',
    error: 'Error',
    starting: 'Starting',
    ...
    testFailed: 'Plugin test failed. Open its configuration or check the server logs for details.',
