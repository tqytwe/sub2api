export default {
    ...
    dashboard: {
      ...
      surchargeIncome: 'Surcharge Income',
      todaySurcharge: 'Today Surcharge',
      rangeSurcharge: 'Selected Range',
      totalSurcharge: 'Total Surcharge',
      surchargeRequests: 'Rows',
      surchargeTime: 'Time',
      surchargeUser: 'User / Key',
      surchargeBase: 'Base Charge',
      surchargeFee: 'Surcharge',
      surchargeBilled: 'Billed',
      noSurchargeRecords: 'No surcharge records',
      surchargePageInfo: 'Page {page} / {pages}',
      prevPage: 'Previous',
      nextPage: 'Next',
