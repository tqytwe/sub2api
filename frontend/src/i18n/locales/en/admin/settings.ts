    ...
    settings: {
      ...
      features: {
        ...
        availableChannels: {
          ...
          enabledHint: 'When off, /catalog does not show signed-in pricing and /api/v1/channels/available returns an empty array.',
        },
        modelPlaza: {
          title: 'Model Plaza',
          description: 'A public page showcasing available models and pricing by group. Disabled by default.',
          enabled: 'Enable Model Plaza',
          enabledHint: 'When enabled, an entry appears in the header and the page is reachable at /catalog.',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsRangeHint: 'Integer 1–100 (percent). Applies to OpenAI, Anthropic, Grok, Kimi, and Zhipu.'
      },
      ...
      payment: {
        ...
        bepusdtManualRefundHint: 'Automatic refunds are unavailable; process on-chain refunds manually.',
        ...
        field_bepusdtApiBaseHint: 'Use the public BEpusdt root URL, for example https://bepusdt.example.com. Do not append /api or /pay. The backend sends the immutable CNY order amount and BEpusdt locks the USDT quote; the network is selected on the BEpusdt checkout from enabled wallets.',
