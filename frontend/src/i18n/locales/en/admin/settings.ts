export default {
    settings: {
      ...
      payment: {
        ...
        providerBepusdt: 'BEpusdt (USDT TRC20)',
        ...
        field_bepusdtApiBaseHint: 'Use the public BEpusdt root URL, for example https://bepusdt.example.com. Do not append /api or /pay. The backend sends the immutable CNY order amount and BEpusdt locks the USDT (TRC20) quote.',
