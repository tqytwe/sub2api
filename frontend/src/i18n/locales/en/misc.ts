export default {
  ...
  payment: {
    ...
    errors: {
      ...
      PLAN_REQUEST_LIMIT_INVALID: 'Request limit must be greater than zero.',
      PLAN_AMOUNT_LIMIT_INVALID: 'Amount limit must be greater than zero.',
      PLAN_TOKEN_LIMIT_INVALID: 'Token limit must be greater than zero.',
