...
const messages = {
  ...
  admin: {
    ...
    funds: {
      ...
      validation: {
        ...
        wholeAmountRequired: '金额必须是大于 0 的整数，例如 30',
      ...
      errors: {
        ...
        FUND_INVALID_AMOUNT: '金额必须是大于 0 的整数',
        FUND_INSUFFICIENT_REFUNDABLE: '可退充值余额不足',
    ...
    subscriptions: {
      ...
      releaseDailyCardHolds: '释放预留',
      releaseDailyCardHoldsTitle: '释放日卡预留',
      releaseDailyCardHoldsConfirm: "确定要释放 '{user}' 当前日卡上的预留请求吗？此操作只释放 reserved hold，不会清空已用额度。",
      dailyCardHoldsReleased: '已释放 {count} 条日卡预留',
      failedToReleaseDailyCardHolds: '释放日卡预留失败',
      restoreDailyCardQuota: '补偿恢复',
      restoreDailyCardQuotaTitle: '补偿恢复本张日卡',
      restoreDailyCardQuotaConfirm: "确定要补偿恢复 '{user}' 的本张日卡吗？此操作会释放预留，并将本张日卡已用额度清零。",
      dailyCardQuotaRestored: '本张日卡已补偿恢复，释放 {count} 条预留',
      failedToRestoreDailyCardQuota: '补偿恢复日卡失败',
  ...
  userSubscriptions: {
    ...
    dailyCardQueued: '另有 {count} 张日卡排队中',
    dailyCardExhausted: '本张日卡额度已用完',
    dailyCardExpired: '本张日卡已到期',
  ...
  payment: {
    ...
    admin: {
      ...
      quotaRule: '额度规则',
      quotaMode: '额度模式',
      quotaModeRecurring: '循环额度',
      quotaModeOneTime: '一次性额度',
      quotaLimitUsd: '总额度（USD）',
      durationHours: '有效时长（小时）',
