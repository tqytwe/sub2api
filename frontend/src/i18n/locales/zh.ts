...
const messages = {
    ...
    settings: {
      ...
      features: {
        ...
        play: {
          ...
          quizRewardPerCorrect: '每题答对奖励（余额）',
  ...
  payment: {
    ...
    qr: {
      ...
      alipayContinueInApp: '请在支付宝内完成支付',
      alipayWaitingHint: '服务器会确认支付结果并自动更新此页面',
      alipayFallbackTitle: '未能打开支付宝',
      alipayFallbackHint: '可以再次尝试打开支付宝，或保存二维码后在支付宝相册扫码',
      reopenAlipay: '重新打开支付宝',
      saveQRCode: '保存二维码',
      alipaySaveAndScanHint: '保存二维码，打开支付宝扫一扫，再从相册选择二维码',
    },
    orders: {
      title: '我的订单',
      empty: '暂无订单',
