...
const messages = {
  ...
  keys: {
    ...
    speedTest: {
      ...
      prompts: {
        concise: '用一句话介绍边缘计算。',
        reasoning: '列出三个判断 API 延迟是否稳定的维度。',
        translation: '将 fast and reliable model gateway 翻译成中文。',
        summary: '用不超过 50 字总结实时流式响应的价值。',
        code: '写一个 JavaScript 函数，返回数组中的最大值。',
      },
    },
    ...
    ccSwitchNotSupportedForPlatform:
      '当前分组平台不支持导入到 CC-Switch，请改用「使用密钥」查看专用配置。',
    ccsClientSelect: {
      title: '选择客户端',
  ...
  affiliate: {
    ...
    yourCode: '我的邀请码',
    inviteLink: '邀请链接',
    teamLinkHint: '链接已包含你的邀请码与小队码 {code}，新用户注册后将自动加入小队。',
    copyCode: '复制邀请码',
    copyLink: '复制链接',
    codeCopied: '邀请码已复制',
    linkCopied: '邀请链接已复制',
  ...
  admin: {
    ...
    funds: {
      ...
      errors: {
        STEP_UP_REQUIRED: '请先完成管理员 TOTP 二次验证',
        STEP_UP_TOTP_NOT_ENABLED: '当前管理员账号未开启 TOTP，请先启用二次验证',
        STEP_UP_ADMIN_API_KEY_FORBIDDEN: '管理员 API Key 不能执行资金操作，请使用管理员账号登录',
        STEP_UP_UNAVAILABLE: '二次验证服务暂不可用，请稍后重试',
        UNAUTHORIZED: '管理员登录已失效，请重新登录',
        FUND_MANAGEMENT_UNAVAILABLE: '资金管理服务暂不可用',
        FUND_INVALID_INPUT: '资金操作参数不正确，请检查用户、原因和管理员会话',
        FUND_INVALID_AMOUNT: '金额必须大于 0，最多保留 8 位小数',
        FUND_INSUFFICIENT_REFUNDABLE: '可退充值余额不足',
        FUND_REFUND_IN_PROGRESS: '该用户已有进行中的充值退回申请',
        FUND_REFUND_ACCOUNT_REQUIRED: '用户尚未设置收款账户',
        FUND_REFUND_NOT_FOUND: '充值退回申请不存在',
        FUND_REFUND_INVALID_STATUS: '当前状态不允许该操作',
        FUND_CLASSIFICATION_NOTHING_TO_DO: '请选择至少一条可复核的历史赠金',
    ...
    withdrawals: {
      ...
      recomputeExistingVerified: '现有权益已核对一致',
      recomputeExistingVerifiedHint: '不会重复写入权益批次；点击“写入复核结果”只更新复核状态和可提现余额。',
      recomputeExistingMismatch: '现有权益与本次重算不一致',
      recomputeExistingMismatchHint: '流水余额不等于可提现金额；暂不能开启提现，请先按页面异常原因完成业务核对后再复核。',
      ...
      recomputeCheckReady: '复核检查已通过',
      recomputeCheckNeedsReview: '复核检查发现需要人工核对的项目',
      recomputeExecutedReady: '复核结果已写入，该用户已通过复核',
      recomputeExecutedNeedsReview: '复核结果已记录，但该用户仍需人工核对',
      recomputeFailed: '可提现复核失败',
      recomputeModes: {
        dry_run: '仅检查',
        execute: '已写入',
        unknown: '未知模式',
      ...
      recomputeSources: {
        ...
        arena_daily_settlement: '农场日榜奖励',
        arena_settlement: '农场月榜奖励',
        team_shared_reward: '组队共享奖励',
        unknown: '未知来源',
      },
      recomputeAnomalyCodes: {
        existing_entitlements: '已有权益批次，请运行复核检查确认是否与本次结果一致。',
        existing_entitlements_mismatch: '已有权益批次与本次重算结果不一致，请先按页面金额和来源完成业务核对。',
        transaction_confidence: '流水 #{transaction_id} 缺少高可信账务标记，需核对来源。',
        missing_balance_before: '流水 #{transaction_id} 缺少可靠的操作前余额，无法安全重放。',
        restore_mismatch: '流水 #{transaction_id} 的退款或回滚无法完整恢复原权益批次。',
        entitlement_exceeds_balance: '计算出的权益总额超过当前余额，需核对历史流水。',
        replay_balance_mismatch: '流水重放余额 {ledger_balance} 与用户当前余额 {user_balance} 不一致。',
        unknown: '发现未知复核异常，请查看服务日志或联系技术复核。',
      },
      userSettingsSaved: '用户提现权限已保存',
      userSettingsSaveFailed: '保存用户提现权限失败',
      batchTitle: '批量权限',
      userIds: '用户 ID 列表',
      userIdsPlaceholder: '每行或用逗号分隔多个用户 ID',
      batchSave: '批量保存',
      batchSettingsSaved: '已更新 {count} 个用户',
      batchSettingsSaveFailed: '批量保存失败',
      queueTitle: '提现队列',
      ...
      errors: {
        ...
        WITHDRAWAL_INSUFFICIENT_WITHDRAWABLE: '可提现余额不足',
        WITHDRAWAL_DAILY_LIMIT_EXCEEDED: '已超过自然日提现上限',
        WITHDRAWAL_MINIMUM_AMOUNT: '金额低于最低提现金额',
        WITHDRAWAL_IN_PROGRESS: '该用户已有进行中的提现申请',
        WITHDRAWAL_ACCOUNT_REQUIRED: '用户尚未设置收款账户',
        WITHDRAWAL_NOT_FOUND: '提现申请不存在',
        WITHDRAWAL_INVALID_STATUS: '当前状态不允许该操作',
        WITHDRAWAL_SELF_REVIEW_FORBIDDEN: '不能审核自己的提现申请',
        WITHDRAWAL_USER_NOT_READY: '该用户尚未通过可提现重算复核',
        WITHDRAWAL_ACCOUNT_ENCRYPTION: '收款资料加密或解密失败',
        USER_NOT_FOUND: '用户不存在',
        BALANCE_LEDGER_UNAVAILABLE: '余额流水服务暂不可用',
        STEP_UP_REQUIRED: '请先完成管理员 TOTP 验证',
        ADMIN_API_KEY_FORBIDDEN: '管理员 API Key 不允许执行该操作',
      },
    },
    // Dashboard
    dashboard: {
    ...
    users: {
      ...
      bulkActions: {
        ...
        stepUpRequired: '执行前需要完成管理员 TOTP 二次验证。',
      ...
      platformOther: '其他',
      balanceHistoryTitle: '用户余额流水',
      noBalanceHistory: '暂无余额流水',
      allTypes: '全部类型',
      typePaymentRecharge: '订单充值',
      typeOfflineRecharge: '线下充值',
      typeBalance: '兑换码充值',
      typeAffiliateBalance: '返利转入',
      typeAdminBalance: '管理员调账',
      typeOpsGift: '管理员赠送',
      typeSignupGift: '注册赠送',
      typeAuthFirstBindGift: '认证首绑赠送',
      typeCompensation: '补偿赠送',
      typeCheckin: '签到',
      typeCheckinMakeup: '补签',
      typeCheckinMilestone: '连续签到奖励',
      typeQuiz: '答题',
      typeBlindbox: '盲盒',
      typeTeamSharedReward: '组队共享奖励',
      typeArenaSettlement: '竞技场结算',
      typeArenaDailySettlement: '日榜结算',
      typeUsageCharge: 'API 消耗',
      typeImageBalanceHold: '图片预留冻结',
      typeImageBalanceCapture: '图片费用结算',
      typeImageBalanceRelease: '图片预留释放',
      typeImageTask: '图片任务',
      typeRefund: '退款扣回',
      typeReversal: '回滚',
      typeFundRefundSubmit: '充值退回申请',
      typeFundRefundCancel: '充值退回取消',
      typeFundRefundReject: '充值退回驳回',
      typeFundRefundPaid: '充值退回打款',
      typePromoBonus: '优惠码奖励',
      typeConcurrency: '并发（兑换码）',
      typeAdminConcurrency: '并发（管理员调整）',
      typeSubscription: '订阅',
      typeWithdrawalSubmit: '提现申请',
      typeWithdrawalCancel: '提现取消',
      typeWithdrawalReject: '提现驳回',
      typeWithdrawalPaid: '提现打款',
      frozenBalance: '冻结余额',
      flowTotalIn: '流入',
      flowTotalOut: '流出',
      flowNetDelta: '净变动',
      ...
      flowColumnTime: '时间',
      flowColumnType: '类型',
      flowColumnAmount: '金额变动',
      flowColumnBalance: '余额前/后',
      flowColumnSource: '关联对象',
      flowColumnActor: '操作人',
      flowColumnNotes: '备注/详情',
      flowDetails: '详情',
      ...
      billingSurchargeMode_none: '不收取',
      billingSurchargeMode_percent_on_charged_cost: '按原扣费比例',
      billingSurchargeMode_additive_multiplier: '倍率加点',
      flowMetadata: {
        account_id: '账号 ID',
        account_type: '账号类型',
        actual_cost: '原始扣费',
        ...
        balance_cost: '余额扣款',
        billed_cost: '实际扣款',
        billing_surcharge_cost: '手续费',
        billing_surcharge_mode: '手续费模式',
        billing_surcharge_value: '手续费数值',
        billing_type: '计费类型',
        ...
        request_id: '请求 ID',
        request_payload_hash: '请求载荷哈希',
        service_tier: '服务档位',
        subscription_id: '订阅 ID',
      },
      flowRelatedObject: '关联对象',
      flowSource: '来源',
      flowReference: '参考号',
      flowSourceBalanceTransactions: '余额流水',
      flowSourcePaymentOrders: '支付订单',
      flowSourceRedeemCodes: '兑换码',
      flowSourcePlayRewards: '玩法奖励',
      flowSourceBlindboxOpen: '盲盒开启',
      flowSourcePromoCodeUsages: '优惠码使用',
      flowSourceUsageLogs: '用量记录',
      flowSourcePaymentAuditLogs: '支付审计',
      flowSourceFundRefundRequest: '充值退回申请',
      flowSourceWithdrawalRequest: '提现申请',
      flowDescriptionOpsGift: '管理员手动赠送',
      flowDescriptionOfflineRecharge: '线下充值到账',
      flowDescriptionFundRefundSubmit: '提交充值退回申请',
      flowDescriptionFundRefundPaid: '充值退回已打款',
      flowDescriptionFundRefundRestored: '充值退回资金恢复',
      flowDescriptionWithdrawalSubmit: '提交提现申请',
      flowDescriptionWithdrawalRestored: '提现资金恢复',
      flowDescriptionWithdrawalPaid: '提现已打款',
      actor_system: '系统',
      actor_admin: '管理员',
      actor_user: '用户',
      confidence_medium: '中等置信',
      confidence_low: '低置信',
      confidence_estimated: '估算',
      confidence_needs_review: '待复核',
      reconcileBalance: '一键对账',
      ledgerBalanceSum: '流水余额',
      ledgerFrozenSum: '流水冻结',
      balanceDifference: '余额差额',
      frozenDifference: '冻结差额',
      subscriptionValidity: '有效期',
      subscriptionOrder: '订单',
      subscriptionPayment: '支付',
      subscriptionPaidAt: '支付时间',
      subscriptionDays: '{days} 天',
      failedToLoadBalanceHistory: '加载余额流水失败',
      createdAt: '创建时间',
      totalRecharged: '总充值',
      // Settings Dropdowns
      filterSettings: '筛选设置',
    ...
    modelCatalog: {
      ...
      batchMultiply: '批量 ×{mult}',
      batchApplyMultiplier: '按官方价应用倍率',
      batchSetGroups: '批量设置分组',
      batchGroupsTitle: '批量设置登录价目分组',
      groupLoadFailed: '加载分组失败',
      groupSelectRequired: '请至少选择一个分组',
      groupModeAuto: '自动匹配',
      groupModeNone: '不匹配分组',
      discoveryTitle: '发现池',
      ...
      fields: {
        ...
        multiplier: '本站倍率',
        importMultiplier: '导入倍率',
        officialCacheRead: '官方缓存读取',
        officialCacheWrite: '官方缓存写入',
        siteInputPerMillion: '本站基础输入 / 1M Token（USD）',
        siteOutputPerMillion: '本站基础输出 / 1M Token（USD）',
        siteCacheReadPerMillion: '本站缓存读取 / 1M Token（USD）',
        siteCacheWritePerMillion: '本站缓存写入 / 1M Token（USD）',
      },
    },
    ...
    settings: {
      ...
      features: {
        ...
        play: {
          ...
          arenaEnabled: 'Token 农场',
          arenaEnabledHint: '月度 Token 排行，/arena。',
          blindboxEnabled: '盲盒',
          blindboxEnabledHint: '扣余额开箱，/blindbox。',
          blindboxCost: '每次开箱消耗（余额）',
          blindboxDailyLimit: '每人每日开箱上限',
          quizEnabled: '答题闯关',
          quizEnabledHint: '每日答题，/quiz-quest。',
          quizRewardPerCorrect: '整次提交后余额分支每题答对奖励',
          quizQuestionsPerDay: '每日题目数量',
          agentTeamEnabled: 'Agent Team',
          agentTeamEnabledHint: '小队创建与邀请，/agent-team。',
        },
        affiliate: {
          title: '邀请返利',
      ...
      payment: {
        ...
        field_displayMerchantName: '支付页商户显示名',
        ...
        field_easypayApiBaseHint: 'KyrenPay 易支付兼容地址填写 https://api.kyrenpay.com/epay；不要填 PID/商户号。其他易支付服务商填写其接口基础地址。',
        field_displayMerchantNameHint: '可选。KyrenPay 支付中间页展示用，会作为 display_merchant_name 提交；留空则由上游按商户资料或登录邮箱兜底显示。',
        field_paymentCurrencyHint: '默认 CNY。Stripe、Airwallex 以及支持 money_type 的易支付服务商可按账户支持选择 HKD、USD 等币种；微信、支付宝仍按 CNY。',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 {siteName}',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 {siteName}。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    errors: {
      ...
      mobilePaymentFallbackToQrCouponHeld: '已切换为扫码支付。为避免重复扣券，原优惠券暂不用于本次二维码订单，待已取消订单确认未支付后会自动恢复。',
      COUPON_NOT_FOUND: '所选优惠券不存在或已不可用，请重新选择。',
      COUPON_NOT_AVAILABLE: '所选优惠券正在订单处理中或已使用，请重新选择。',
      COUPON_EXPIRED: '所选优惠券已过期，请重新选择。',
      COUPON_TERMS_INVALID: '所选优惠券规则已变更，无法使用，请重新选择。',
      COUPON_SCOPE_MISMATCH: '所选优惠券不适用于当前订单。',
      COUPON_MINIMUM_NOT_MET: '当前订单未达到优惠券使用门槛。',
      COUPON_PLAN_MISMATCH: '所选优惠券不适用于当前订阅套餐。',
      COUPON_CURRENCY_MISMATCH: '所选优惠券不适用于当前支付币种。',
      COUPON_QUOTE_CHANGED: '优惠券试算结果已变化，请重新选择后再支付。',
      COUPON_SERVICE_UNAVAILABLE: '优惠券服务暂时不可用，请稍后重试。',
      INVALID_USER_COUPON_ID: '优惠券信息无效，请重新选择。',
      INVALID_COUPON_ORDER: '优惠券订单信息无效，请重新选择后重试。',
      INVALID_COUPON_SETTLEMENT: '优惠券金额试算异常，请重新选择后重试。',
    ...
    planShelf: {
      ...
      summary: '{platform} / {category}：共 {count} 个套餐，当前展示 {shown} 个',
      empty: '{platform} 下暂无 {category} 套餐',
      expandAll: '展开全部 {count} 个套餐',
      reset: '重置筛选',
