...
export default {
  ...
  admin: {
    ...
    modelCatalog: {
      title: '模型价目管理',
      description: '控制游客/登录用户看到的模型展示、排序与参考价；登录实付价仍来自渠道定价 × 分组倍率',
      ...
      columns: {
        model: '模型',
        platform: '平台',
        officialInput: 'AIHubMix 官方输入',
        officialOutput: 'AIHubMix 官方输出',
        channelInput: '计费基础输入',
        channelOutput: '计费基础输出',
        input: '本站参考输入',
        output: '本站参考输出',
        inputDiff: '输入差价',
        outputDiff: '输出差价',
      ...
      fields: {
        ...
        siteInputPerMillion: '本站输入 / 1M Token（USD）',
        siteOutputPerMillion: '本站输出 / 1M Token（USD）',
    ...
    settings: {
      ...
      features: {
        ...
        play: {
          ...
          publicModelsEnabledHint: '游客可在 /models 查看管理员勾选为「游客可见」的模型与参考价。',
          checkinEnabled: '每日签到',
