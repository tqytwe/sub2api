      ...
      <template v-else>
        ...
        >
          <div class="flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            >
              <!-- design-governance-allow: continuous-motion - catalog refresh rotation exists only while the request is loading and motion-reduce:animate-none stops it for reduced-motion users. -->
              <Icon :class="codexModelManifestState === 'loading' ? 'animate-spin motion-reduce:animate-none' : ''"
                name="refresh"
                size="sm"
                class="mr-1.5"
              />
