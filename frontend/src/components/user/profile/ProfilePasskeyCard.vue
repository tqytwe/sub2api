  ...
  <div class="card">
    ...
    <div class="px-6 py-6">
      ...
      <div>
        ...
        <div v-if="loading" class="flex justify-center py-6">
          <!-- design-governance-allow: continuous-motion - passkey credential loading indicator is temporary and hidden after fetch settles. -->
    ...
    <div v-if="deleteTarget" class="fixed inset-0 z-50 overflow-y-auto">
      <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div
          class="relative w-full max-w-md transform rounded-lg bg-white p-6 shadow-xl transition-[opacity,transform] dark:bg-dark-800"
        >
