  ...
  >
    ...
    <div class="flex flex-wrap items-center gap-1.5">
      <button
        ...
        @click="handleProbe()"
      >
        <!-- design-governance-allow: inline-svg - existing compact provider quota status glyph has no matching shared Icon path. --> <!-- design-governance-allow: continuous-motion - quota probe rotation exists only while the request is loading and motion-reduce:animate-none stops it for reduced-motion users. -->
        <svg :class="{ 'animate-spin motion-reduce:animate-none': loading }"
          class="h-2.5 w-2.5"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
