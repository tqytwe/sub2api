  ...
  <div v-if="visible" class="space-y-1">
    <div class="flex flex-wrap items-center gap-1.5">
      <button
        ...
        @click="handleProbe()"
      >
        <!-- design-governance-allow: inline-svg - the refresh mark is a shared small status glyph without a matching Icon path. --> <!-- design-governance-allow: continuous-motion - probe feedback is user-triggered and disabled for reduced-motion users. -->
        <svg class="h-2.5 w-2.5" :class="{ 'animate-spin motion-reduce:animate-none': loading }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
