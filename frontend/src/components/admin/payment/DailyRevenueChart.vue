...
const colors = [
  // design-governance-allow: raw-color - Chart.js datasets require concrete canvas colors, centralized here for payment statistics.
  ...
  return {
    ...
    datasets: [
      ...
      }),
      {
        ...
        // design-governance-allow: raw-color - Chart.js order-count line needs a concrete canvas stroke color.
        borderColor: 'rgb(16, 185, 129)',
        // design-governance-allow: raw-color - Chart.js order-count fill needs a concrete canvas color.
