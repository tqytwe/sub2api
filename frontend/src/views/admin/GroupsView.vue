  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <div class="md:col-span-2">
          <div class="grid gap-3 rounded-lg border border-gray-200 p-3 dark:border-dark-600 md:grid-cols-4" data-testid="create-group-surcharge-panel">
            <label class="flex min-h-10 items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input v-model="createForm.billing_surcharge_override_enabled" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500" data-testid="create-group-surcharge-override" />
              {{ t("admin.groups.surcharge.override") }}
            </label>
            <label class="flex min-h-10 items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input v-model="createForm.billing_surcharge_enabled" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500" :disabled="!createForm.billing_surcharge_override_enabled" data-testid="create-group-surcharge-enabled" />
              {{ t("admin.groups.surcharge.enabled") }}
            </label>
            <div>
              <label class="input-label">{{ t("admin.groups.surcharge.modeLabel") }}</label>
              <select v-model="createForm.billing_surcharge_mode" class="input" :disabled="!createForm.billing_surcharge_override_enabled" data-testid="create-group-surcharge-mode">
                <option value="none">{{ t("admin.groups.surcharge.modeNone") }}</option>
                <option value="percent_on_charged_cost">{{ t("admin.groups.surcharge.modePercent") }}</option>
                <option value="additive_multiplier">{{ t("admin.groups.surcharge.modeAdditive") }}</option>
              </select>
            </div>
            <div>
              <label class="input-label">{{ t("admin.groups.surcharge.valueLabel") }}</label>
              <input v-model.number="createForm.billing_surcharge_value" type="number" min="0" step="0.0001" class="input" :disabled="!createForm.billing_surcharge_override_enabled" :placeholder="t('admin.groups.surcharge.valuePlaceholder')" data-testid="create-group-surcharge-value" />
            </div>
          </div>
            ...
            <div class="border-t border-gray-200 px-3 py-2 dark:border-dark-600">
              <div class="flex items-center gap-2">
                <input
                  ...
                  class="min-w-0 flex-1 rounded border border-gray-300 bg-white px-2 py-1.5 text-sm text-gray-700 focus:border-primary-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:border-dark-500 dark:bg-dark-700 dark:text-gray-200"
    ...
    >
      ...
      >
        ...
        <div class="md:col-span-2">
          <div class="grid gap-3 rounded-lg border border-gray-200 p-3 dark:border-dark-600 md:grid-cols-4" data-testid="edit-group-surcharge-panel">
            <label class="flex min-h-10 items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input v-model="editForm.billing_surcharge_override_enabled" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500" data-testid="edit-group-surcharge-override" />
              {{ t("admin.groups.surcharge.override") }}
            </label>
            <label class="flex min-h-10 items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
              <input v-model="editForm.billing_surcharge_enabled" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500" :disabled="!editForm.billing_surcharge_override_enabled" data-testid="edit-group-surcharge-enabled" />
              {{ t("admin.groups.surcharge.enabled") }}
            </label>
            <div>
              <label class="input-label">{{ t("admin.groups.surcharge.modeLabel") }}</label>
              <select v-model="editForm.billing_surcharge_mode" class="input" :disabled="!editForm.billing_surcharge_override_enabled" data-testid="edit-group-surcharge-mode">
                <option value="none">{{ t("admin.groups.surcharge.modeNone") }}</option>
                <option value="percent_on_charged_cost">{{ t("admin.groups.surcharge.modePercent") }}</option>
                <option value="additive_multiplier">{{ t("admin.groups.surcharge.modeAdditive") }}</option>
              </select>
            ...
            <div>
              <label class="input-label">{{ t("admin.groups.surcharge.valueLabel") }}</label>
              <input v-model.number="editForm.billing_surcharge_value" type="number" min="0" step="0.0001" class="input" :disabled="!editForm.billing_surcharge_override_enabled" :placeholder="t('admin.groups.surcharge.valuePlaceholder')" data-testid="edit-group-surcharge-value" />
            </div>
          </div>
          <p class="input-hint">{{ t("admin.groups.surcharge.hint") }}</p>
        </div>
