    ...
    <div :class="['rounded-3xl bg-white shadow-sm ring-1 ring-gray-900/5 dark:bg-dark-800 dark:ring-dark-700', props.fullscreen ? 'p-8' : 'p-6']">
      <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 pb-4 dark:border-dark-700">
        <div class="space-y-2">
          ...
          <!-- design-governance-allow: page-shell-ownership - max-width constrains a skeleton line inside a component, not a route frame. --> <!-- design-governance-allow: continuous-motion - the skeleton stops animating when reduced motion is requested. -->
          <div class="h-3 w-80 max-w-full animate-pulse rounded bg-gray-100 dark:bg-dark-700/70 motion-reduce:animate-none"></div>
        </div>
