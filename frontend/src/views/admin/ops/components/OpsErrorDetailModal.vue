  ...
  <BaseDialog :show="show" :title="title" width="full" :close-on-click-outside="true" @close="close">
    ...
    <div v-else class="space-y-6 p-6">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div v-if="detail.api_key_prefix" class="rounded-lg bg-gray-50 p-4 dark:bg-dark-900">
      ...
      <div v-if="rootCauseMessage" class="rounded-lg bg-amber-50 p-6 dark:bg-amber-900/10">
      ...
      <div class="rounded-lg bg-gray-50 p-6 dark:bg-dark-900">
        ...
        <div v-else class="mt-4 space-y-4">
          <div v-for="section in diagnosticPayloadSections" :key="section.key">
            ...
            <pre class="max-h-[520px] overflow-auto rounded-lg border border-gray-200 bg-white p-4 text-xs text-gray-800 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-100"><code>{{ prettyJSON(section.value) }}</code></pre>
          </div>
        </div>
      </div>

      <!-- Upstream errors list (only for request errors) -->
      <div v-if="showUpstreamList" class="rounded-lg bg-gray-50 p-6 dark:bg-dark-900">
        ...
        <div v-else class="mt-4 space-y-3">
          ...
          >
            ...
            <pre
              ...
              class="mt-3 max-h-[240px] overflow-auto rounded-lg border border-gray-200 bg-gray-50 p-3 text-xs text-gray-800 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-100"
