    ...
    <main class="models-main">
      ...
      <div v-if="showGuestLoginBanner" class="models-auth-card">
        ...
        <div class="models-auth-actions">
          <router-link to="/login" class="models-btn models-btn-primary">{{ t('models.loginCta') }}</router-link>
          <router-link to="/register" class="models-btn models-btn-secondary">{{ t('models.registerCta') }}</router-link>
        </div>
      </div>
