<template>
  <!-- 管理员自定义首页内容优先 -->
  <div v-if="hasHomeContent" class="custom-home-page">
    <iframe
  ...
  <!-- Compact Home Page -->
  <div v-else-if="compactHomeEnabled" data-testid="compact-home" class="flex flex-1 flex-col bg-gray-50 text-gray-900 dark:bg-dark-950 dark:text-white">
