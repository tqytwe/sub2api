...
export type AnnouncementConditionType = 'subscription' | 'balance' | 'play_membership'
...
export interface AnnouncementCondition {
  ...
  operator: AnnouncementOperator
	group_ids?: number[]
	value?: number
	play_membership?: 'ordinary' | 'member'
}
...
export interface AccountUsageInfo {
  ...
  // Official monthly window used by billing-aware Grok fallback display.
