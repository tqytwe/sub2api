...
.score-legend {
  background: var(--monitor-health-0);
}
...
.pulse-cell.has-data:focus-visible {
  outline: 2px solid color-mix(in srgb, var(--border-focus) 55%, transparent);
  outline-offset: 1px;
  z-index: 5;
}
...
.pulse-tooltip {
  ...
  border: 1px solid var(--monitor-tooltip-border);
  background: var(--monitor-tooltip-surface);
  padding: 0.5rem 0.625rem;
  box-shadow: 0 10px 25px -5px color-mix(in srgb, var(--text-primary) 15%, transparent);
  opacity: 0;
  visibility: hidden;
...
:global(.dark) .pulse-tooltip {
  border-color: var(--monitor-tooltip-border);
  background: var(--monitor-tooltip-surface);
  color: var(--monitor-tooltip-text);
}
.pulse-tooltip-line {
  display: block;
  font-size: 11px;
  line-height: 1.45;
  color: var(--monitor-tooltip-muted);
}
...
.matrix-floating-tooltip {
  ...
  background: var(--monitor-tooltip-surface);
  padding: 0.5rem 0.625rem;
  box-shadow: 0 18px 40px -12px color-mix(in srgb, var(--text-primary) 28%, transparent);
  white-space: nowrap;
}
