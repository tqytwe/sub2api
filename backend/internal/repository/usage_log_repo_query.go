...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		subscriptionEntitlementID sql.NullInt64
		inputTokens               int
		outputTokens              int
	...
	if err := scanner.Scan(
		...
		&sessionID,
		&createdAt,
		&billingSurchargeCost,
		&billedCost,
		&billingSurchargeMode,
		&billingSurchargeValue,
		&inputAudioTokens,
		&outputAudioTokens,
	...
	log := &service.UsageLog{
		...
		CacheReadAudioTokens:      cacheReadAudioTokens,
		...
		BillingSurchargeCost:      billingSurchargeCost,
		BilledCost:                billedCost,
		BillingSurchargeMode:      billingSurchargeMode,
		BillingSurchargeValue:     billingSurchargeValue,
	...
	if subscriptionEntitlementID.Valid {
		value := subscriptionEntitlementID.Int64
		log.SubscriptionEntitlementID = &value
	}
	if durationMs.Valid {
