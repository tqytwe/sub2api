...
func (h *GroupHandler) Create(c *gin.Context) {
	...
	group, err := h.adminService.CreateGroup(c.Request.Context(), &service.CreateGroupInput{
		...
		BillingSurchargeOverrideEnabled: req.BillingSurchargeOverrideEnabled,
		BillingSurchargeEnabled:         req.BillingSurchargeEnabled,
		BillingSurchargeMode:            req.BillingSurchargeMode,
		BillingSurchargeValue:           req.BillingSurchargeValue,
