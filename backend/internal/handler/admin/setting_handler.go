...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		BillingSurchargeEnabled:                                settings.BillingSurchargeEnabled,
		BillingSurchargeMode:                                   settings.BillingSurchargeMode,
		BillingSurchargeValue:                                  settings.BillingSurchargeValue,
