...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		PlayCheckinDailyReward:     settings.PlayCheckinDailyReward,
		PlayArenaEnabled:           settings.PlayArenaEnabled,
		PlayBlindboxEnabled:        settings.PlayBlindboxEnabled,
		PlayBlindboxCost:           settings.PlayBlindboxCost,
		PlayBlindboxDailyLimit:     settings.PlayBlindboxDailyLimit,
		PlayQuizEnabled:            settings.PlayQuizEnabled,
		PlayQuizRewardPerCorrect:   settings.PlayQuizRewardPerCorrect,
		PlayQuizQuestionsPerDay:    settings.PlayQuizQuestionsPerDay,
...
type UpdateSettingsRequest struct {
	...
	PlayCheckinDailyReward     *float64 `json:"play_checkin_daily_reward"`
	PlayArenaEnabled           *bool    `json:"play_arena_enabled"`
	PlayBlindboxEnabled        *bool    `json:"play_blindbox_enabled"`
	PlayBlindboxCost           *float64 `json:"play_blindbox_cost"`
	PlayBlindboxDailyLimit     *int     `json:"play_blindbox_daily_limit"`
	PlayQuizEnabled            *bool    `json:"play_quiz_enabled"`
	PlayQuizRewardPerCorrect   *float64 `json:"play_quiz_reward_per_correct"`
	PlayQuizQuestionsPerDay    *int     `json:"play_quiz_questions_per_day"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		PlayCheckinDailyReward: func() float64 {
			if req.PlayCheckinDailyReward != nil {
				return *req.PlayCheckinDailyReward
			}
			return previousSettings.PlayCheckinDailyReward
		}(),
		...
		PlayBlindboxCost: func() float64 {
			if req.PlayBlindboxCost != nil {
				return *req.PlayBlindboxCost
			}
			return previousSettings.PlayBlindboxCost
		}(),
		PlayBlindboxDailyLimit: func() int {
			if req.PlayBlindboxDailyLimit != nil {
				return *req.PlayBlindboxDailyLimit
			}
			return previousSettings.PlayBlindboxDailyLimit
		}(),
		...
		PlayQuizRewardPerCorrect: func() float64 {
			if req.PlayQuizRewardPerCorrect != nil {
				return *req.PlayQuizRewardPerCorrect
			}
			return previousSettings.PlayQuizRewardPerCorrect
		}(),
		PlayQuizQuestionsPerDay: func() int {
			if req.PlayQuizQuestionsPerDay != nil {
				return *req.PlayQuizQuestionsPerDay
			}
			return previousSettings.PlayQuizQuestionsPerDay
		}(),
	...
	payload := dto.SystemSettings{
		...
		PlayCheckinDailyReward:     updatedSettings.PlayCheckinDailyReward,
		PlayArenaEnabled:           updatedSettings.PlayArenaEnabled,
		PlayBlindboxEnabled:        updatedSettings.PlayBlindboxEnabled,
		PlayBlindboxCost:           updatedSettings.PlayBlindboxCost,
		PlayBlindboxDailyLimit:     updatedSettings.PlayBlindboxDailyLimit,
		PlayQuizEnabled:            updatedSettings.PlayQuizEnabled,
		PlayQuizRewardPerCorrect:   updatedSettings.PlayQuizRewardPerCorrect,
		PlayQuizQuestionsPerDay:    updatedSettings.PlayQuizQuestionsPerDay,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.PublicModelsEnabled != after.PublicModelsEnabled {
		changed = append(changed, "public_models_enabled")
	}
	if before.PlayCheckinEnabled != after.PlayCheckinEnabled {
		changed = append(changed, "play_checkin_enabled")
	}
	if before.PlayCheckinDailyReward != after.PlayCheckinDailyReward {
		changed = append(changed, "play_checkin_daily_reward")
	}
	...
	if before.PlayBlindboxCost != after.PlayBlindboxCost {
		changed = append(changed, "play_blindbox_cost")
	}
	if before.PlayBlindboxDailyLimit != after.PlayBlindboxDailyLimit {
		changed = append(changed, "play_blindbox_daily_limit")
	}
	if before.PlayQuizEnabled != after.PlayQuizEnabled {
		changed = append(changed, "play_quiz_enabled")
	}
	if before.PlayQuizRewardPerCorrect != after.PlayQuizRewardPerCorrect {
		changed = append(changed, "play_quiz_reward_per_correct")
	}
	if before.PlayQuizQuestionsPerDay != after.PlayQuizQuestionsPerDay {
		changed = append(changed, "play_quiz_questions_per_day")
	}
