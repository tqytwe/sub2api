...
const (
	...
	SubscriptionStatusExhausted = domain.SubscriptionStatusExhausted
...
const (
	...
	SettingKeySupportContactConfig        = "support_contact_config"        // 结构化客服联系方式配置（JSON）
	SettingKeyAPIOnboardingConfig         = "api_onboarding_config"         // API Key 新手接入推荐配置（JSON）
	...
	SettingKeyPlayTeamSharedRewardEnabled     = "play_team_shared_reward_enabled"
	SettingKeyPlayTeamSharedRewardTiers       = "play_team_shared_reward_tiers"
	SettingKeyPlayTeamSharedRewardCap         = "play_team_shared_reward_cap"
