...
var balanceLedgerDirectWritePatterns = []*regexp.Regexp{
	...
	regexp.MustCompile(`\bwithdrawable_balance\s*=`),
	regexp.MustCompile(`\bwithdrawal_frozen_balance\s*=`),
...
var balanceLedgerAllowedDirectWriteFiles = map[string]string{
	...
	"service/withdrawable_recompute.go": "controlled CP4 recomputation script updates withdrawable snapshots after high-confidence replay",
