...
func TestResolveImageStudioProviderCapabilityUsesProviderSpecificProfiles(t *testing.T) {
	...
	require.Equal(t, "aspect_resolution", agnes20.SizingKind)
	require.Equal(t, []string{"1:1", "2:3", "3:2", "9:16", "16:9"}, agnes20.SupportedAspectRatios)
	require.Equal(t, []string{"1k", "2k", "3k", "4k"}, agnes20.SupportedResolutions)
	require.Contains(t, agnes20.SupportedSizes, "3840x2160")
