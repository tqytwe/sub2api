...
const (
	...
	AuditActionAdminFundCompensation              = "admin.fund.compensation.grant"
	AuditActionAdminFundOperationCorrection       = "admin.fund.operation.account_correction"
	AuditActionAdminFundOperationCorrectionRetry  = "admin.fund.operation.account_correction.retry"
	AuditActionAdminFundOperationCorrectionCancel = "admin.fund.operation.account_correction.cancel"
	AuditActionAdminFundOperationSensitiveRead    = "admin.fund.operation.sensitive.read"
