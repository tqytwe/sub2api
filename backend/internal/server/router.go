...
func SetupRouter(
	...
	// 注册路由
	registerRoutes(r, handlers, jwtAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, opsService, settingService, dashboardService, modelCatalogService, promptLibraryService, compositeResolver, cfg, redisClient)
...
func registerRoutes(
	...
	v1.POST("/mobile/assets", gin.HandlerFunc(jwtAuth), mobileAssets.Upload)
	...
	v1.POST("/mobile/support/tickets", gin.HandlerFunc(jwtAuth), h.MobileSupport.Create)
