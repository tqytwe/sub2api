...
func registerAdminPlayRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	play := admin.Group("/play")
	{
		...
		play.GET("/mobile-releases", h.Admin.Play.ListMobileReleases)
		play.POST("/mobile-releases/upload", h.Admin.Play.UploadMobileRelease)
		play.POST("/mobile-releases/:id/publish", h.Admin.Play.PublishMobileRelease)
		play.POST("/mobile-releases/:id/pause", h.Admin.Play.PauseMobileRelease)
		play.POST("/mobile-releases/:id/retire", h.Admin.Play.RetireMobileRelease)
...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/image-runtimes/health", h.Admin.Ops.GetImageRuntimesHealth)
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/billing-surcharge", h.Admin.Dashboard.GetBillingSurchargeReport)
...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/exclusive-groups/preview", h.Admin.User.PreviewExclusiveGroup)
		users.POST("/exclusive-groups", h.Admin.User.ExecuteExclusiveGroup)
		users.POST("/exclusive-groups/csv/preview", h.Admin.User.PreviewExclusiveGroupCSV)
		users.POST("/exclusive-groups/csv", h.Admin.User.ExecuteExclusiveGroupCSV)
		...
		users.GET("/:id/balance-reconciliation", h.Admin.User.GetBalanceReconciliation)
