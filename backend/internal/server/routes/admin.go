...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/:id/daily-card/:entitlement_id/restore-quota", h.Admin.Subscription.RestoreDailyCardQuota)
		subscriptions.GET("/:id/daily-card/:entitlement_id/requests/:client_request_id", h.Admin.Subscription.GetDailyCardRequestReplay)
		subscriptions.POST("/:id/daily-card/:entitlement_id/requests/:client_request_id/reconcile", h.Admin.Subscription.ReconcileDailyCardRequest)
