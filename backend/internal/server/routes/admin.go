...
func registerAdminPlayRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	play := admin.Group("/play")
	{
		...
		play.PUT("/arena/rewards", h.Admin.Play.UpdateArenaRewardSettings)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/:id/daily-card/:entitlement_id/release-holds", h.Admin.Subscription.ReleaseDailyCardHolds)
