...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/admin/funds/refund-requests/:request_no/payout-sensitive": service.AuditActionAdminFundRefundRead,
	"GET /api/v1/admin/funds/operations/:operation_no/sensitive":           service.AuditActionAdminFundOperationSensitiveRead,
	"GET /api/v1/admin/funds/classifications/signup-gift-30/preview":       service.AuditActionAdminFundClassifyPreview,
}
...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/withdrawals/users/:id/recompute":                   service.AuditActionAdminWithdrawalRecompute,
	"POST /api/v1/admin/withdrawals/users/:id/recompute/execute":           service.AuditActionAdminWithdrawalRecompute,
