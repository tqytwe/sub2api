...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	affiliateService := service.NewAffiliateService(affiliateRepository, settingService, apiKeyAuthCacheInvalidator, billingCacheService, balanceLedgerService)
	authService := service.NewAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, affiliateService, serviceUserPlatformQuotaRepository, balanceLedgerService)
	...
	usageService := service.NewUsageService(usageLogRepository, userRepository, client, apiKeyAuthCacheInvalidator, balanceLedgerService)
	...
	playService := service.NewPlayService(playRepository, userRepository, channelService, settingService, affiliateService, client, balanceLedgerService)
