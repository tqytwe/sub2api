...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	ipRiskService := service.ProvideIPRiskService(ipRiskRepository, leaderLockCache, db, ipRiskHasher, ipRiskRuntimeConfig)
	...
	playService := service.ProvidePlayService(playRepository, userRepository, channelService, settingService, affiliateService, client, balanceLedgerService)
	...
	ipRiskHandler := admin.NewIPRiskHandler(ipRiskService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, dashboardService, modelCatalogService, promptLibraryService, redisClient)
