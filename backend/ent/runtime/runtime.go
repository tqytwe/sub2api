...
func init() {
	...
	paymentorderDescClientIP := paymentorderFields[46].Descriptor()
	...
	paymentorderDescSrcHost := paymentorderFields[47].Descriptor()
	...
	paymentorderDescCreatedAt := paymentorderFields[49].Descriptor()
	// paymentorder.DefaultCreatedAt holds the default value on creation for the created_at field.
	paymentorder.DefaultCreatedAt = paymentorderDescCreatedAt.Default.(func() time.Time)
	// paymentorderDescUpdatedAt is the schema descriptor for updated_at field.
	paymentorderDescUpdatedAt := paymentorderFields[50].Descriptor()
	...
	usagelogDescBillingSurchargeCost := usagelogFields[27].Descriptor()
	...
	usagelogDescBilledCost := usagelogFields[28].Descriptor()
	...
	usagelogDescBillingSurchargeMode := usagelogFields[29].Descriptor()
	...
	usagelogDescBillingSurchargeValue := usagelogFields[30].Descriptor()
