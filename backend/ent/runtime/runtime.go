...
func init() {
	...
	// groupDescBillingSurchargeOverrideEnabled is the schema descriptor for billing_surcharge_override_enabled field.
	groupDescBillingSurchargeOverrideEnabled := groupFields[3].Descriptor()
	// group.DefaultBillingSurchargeOverrideEnabled holds the default value on creation for the billing_surcharge_override_enabled field.
	group.DefaultBillingSurchargeOverrideEnabled = groupDescBillingSurchargeOverrideEnabled.Default.(bool)
	// groupDescBillingSurchargeEnabled is the schema descriptor for billing_surcharge_enabled field.
	groupDescBillingSurchargeEnabled := groupFields[4].Descriptor()
	// group.DefaultBillingSurchargeEnabled holds the default value on creation for the billing_surcharge_enabled field.
	group.DefaultBillingSurchargeEnabled = groupDescBillingSurchargeEnabled.Default.(bool)
	// groupDescBillingSurchargeMode is the schema descriptor for billing_surcharge_mode field.
	groupDescBillingSurchargeMode := groupFields[5].Descriptor()
	// group.DefaultBillingSurchargeMode holds the default value on creation for the billing_surcharge_mode field.
	group.DefaultBillingSurchargeMode = groupDescBillingSurchargeMode.Default.(string)
	// group.BillingSurchargeModeValidator is a validator for the "billing_surcharge_mode" field. It is called by the builders before save.
	group.BillingSurchargeModeValidator = groupDescBillingSurchargeMode.Validators[0].(func(string) error)
	// groupDescBillingSurchargeValue is the schema descriptor for billing_surcharge_value field.
	groupDescBillingSurchargeValue := groupFields[6].Descriptor()
	// group.DefaultBillingSurchargeValue holds the default value on creation for the billing_surcharge_value field.
	group.DefaultBillingSurchargeValue = groupDescBillingSurchargeValue.Default.(float64)
	// groupDescPeakRateEnabled is the schema descriptor for peak_rate_enabled field.
	groupDescPeakRateEnabled := groupFields[7].Descriptor()
	...
	groupDescPeakStart := groupFields[8].Descriptor()
	...
	groupDescPeakEnd := groupFields[9].Descriptor()
	...
	groupDescPeakRateMultiplier := groupFields[10].Descriptor()
	...
	// paymentorderDescListAmount is the schema descriptor for list_amount field.
	paymentorderDescListAmount := paymentorderFields[8].Descriptor()
	// paymentorder.DefaultListAmount holds the default value on creation for the list_amount field.
	paymentorder.DefaultListAmount = paymentorderDescListAmount.Default.(float64)
	// paymentorderDescGatewayBaseAmount is the schema descriptor for gateway_base_amount field.
	paymentorderDescGatewayBaseAmount := paymentorderFields[9].Descriptor()
	...
	paymentorderDescFeeAmount := paymentorderFields[11].Descriptor()
	...
	// paymentorderDescQualifyingRechargeAmount is the schema descriptor for qualifying_recharge_amount field.
	paymentorderDescQualifyingRechargeAmount := paymentorderFields[12].Descriptor()
	// paymentorder.DefaultQualifyingRechargeAmount holds the default value on creation for the qualifying_recharge_amount field.
	paymentorder.DefaultQualifyingRechargeAmount = paymentorderDescQualifyingRechargeAmount.Default.(float64)
	// paymentorderDescPaymentCurrency is the schema descriptor for payment_currency field.
	paymentorderDescPaymentCurrency := paymentorderFields[13].Descriptor()
	...
	paymentorderDescFeeRate := paymentorderFields[15].Descriptor()
	...
	subscriptionentitlementholdFields := schema.SubscriptionEntitlementHold{}.Fields()
	_ = subscriptionentitlementholdFields
	// subscriptionentitlementholdDescRequestID is the schema descriptor for request_id field.
	subscriptionentitlementholdDescRequestID := subscriptionentitlementholdFields[1].Descriptor()
	// subscriptionentitlementhold.RequestIDValidator is a validator for the "request_id" field. It is called by the builders before save.
	subscriptionentitlementhold.RequestIDValidator = subscriptionentitlementholdDescRequestID.Validators[0].(func(string) error)
	// subscriptionentitlementholdDescRequestFingerprint is the schema descriptor for request_fingerprint field.
	subscriptionentitlementholdDescRequestFingerprint := subscriptionentitlementholdFields[2].Descriptor()
	// subscriptionentitlementhold.RequestFingerprintValidator is a validator for the "request_fingerprint" field. It is called by the builders before save.
	subscriptionentitlementhold.RequestFingerprintValidator = subscriptionentitlementholdDescRequestFingerprint.Validators[0].(func(string) error)
	// subscriptionentitlementholdDescCapturedUsd is the schema descriptor for captured_usd field.
	subscriptionentitlementholdDescCapturedUsd := subscriptionentitlementholdFields[4].Descriptor()
	// subscriptionentitlementhold.DefaultCapturedUsd holds the default value on creation for the captured_usd field.
	subscriptionentitlementhold.DefaultCapturedUsd = subscriptionentitlementholdDescCapturedUsd.Default.(float64)
	// subscriptionentitlementholdDescStatus is the schema descriptor for status field.
	subscriptionentitlementholdDescStatus := subscriptionentitlementholdFields[5].Descriptor()
	// subscriptionentitlementhold.DefaultStatus holds the default value on creation for the status field.
	subscriptionentitlementhold.DefaultStatus = subscriptionentitlementholdDescStatus.Default.(string)
	// subscriptionentitlementhold.StatusValidator is a validator for the "status" field. It is called by the builders before save.
	subscriptionentitlementhold.StatusValidator = subscriptionentitlementholdDescStatus.Validators[0].(func(string) error)
	// subscriptionentitlementholdDescCreatedAt is the schema descriptor for created_at field.
	subscriptionentitlementholdDescCreatedAt := subscriptionentitlementholdFields[9].Descriptor()
	// subscriptionentitlementhold.DefaultCreatedAt holds the default value on creation for the created_at field.
	subscriptionentitlementhold.DefaultCreatedAt = subscriptionentitlementholdDescCreatedAt.Default.(func() time.Time)
	// subscriptionentitlementholdDescUpdatedAt is the schema descriptor for updated_at field.
	subscriptionentitlementholdDescUpdatedAt := subscriptionentitlementholdFields[10].Descriptor()
	// subscriptionentitlementhold.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	subscriptionentitlementhold.DefaultUpdatedAt = subscriptionentitlementholdDescUpdatedAt.Default.(func() time.Time)
	// subscriptionentitlementhold.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	subscriptionentitlementhold.UpdateDefaultUpdatedAt = subscriptionentitlementholdDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	// subscriptionplanDescQuotaMode is the schema descriptor for quota_mode field.
	subscriptionplanDescQuotaMode := subscriptionplanFields[8].Descriptor()
	// subscriptionplan.DefaultQuotaMode holds the default value on creation for the quota_mode field.
	subscriptionplan.DefaultQuotaMode = subscriptionplanDescQuotaMode.Default.(string)
	// subscriptionplan.QuotaModeValidator is a validator for the "quota_mode" field. It is called by the builders before save.
	subscriptionplan.QuotaModeValidator = subscriptionplanDescQuotaMode.Validators[0].(func(string) error)
	...
	// subscriptionplanDescCoverImageURL is the schema descriptor for cover_image_url field.
	subscriptionplanDescCoverImageURL := subscriptionplanFields[13].Descriptor()
	// subscriptionplan.DefaultCoverImageURL holds the default value on creation for the cover_image_url field.
	subscriptionplan.DefaultCoverImageURL = subscriptionplanDescCoverImageURL.Default.(string)
	// subscriptionplanDescDetailDescription is the schema descriptor for detail_description field.
	subscriptionplanDescDetailDescription := subscriptionplanFields[14].Descriptor()
	...
	subscriptionplanDescStorefrontPlatform := subscriptionplanFields[15].Descriptor()
	...
	subscriptionplanDescStorefrontCategory := subscriptionplanFields[16].Descriptor()
	...
	subscriptionplanDescStorefrontFeatured := subscriptionplanFields[17].Descriptor()
	...
	subscriptionplanDescStorefrontBadge := subscriptionplanFields[18].Descriptor()
	...
	subscriptionplanDescForSale := subscriptionplanFields[19].Descriptor()
	...
	subscriptionplanDescSortOrder := subscriptionplanFields[20].Descriptor()
	...
	// usagelogDescBillingSurchargeCost is the schema descriptor for billing_surcharge_cost field.
	usagelogDescBillingSurchargeCost := usagelogFields[26].Descriptor()
	// usagelog.DefaultBillingSurchargeCost holds the default value on creation for the billing_surcharge_cost field.
	usagelog.DefaultBillingSurchargeCost = usagelogDescBillingSurchargeCost.Default.(float64)
	// usagelogDescBilledCost is the schema descriptor for billed_cost field.
	usagelogDescBilledCost := usagelogFields[27].Descriptor()
	...
	// usagelogDescBillingSurchargeMode is the schema descriptor for billing_surcharge_mode field.
	usagelogDescBillingSurchargeMode := usagelogFields[28].Descriptor()
	// usagelog.DefaultBillingSurchargeMode holds the default value on creation for the billing_surcharge_mode field.
	usagelog.DefaultBillingSurchargeMode = usagelogDescBillingSurchargeMode.Default.(string)
	// usagelog.BillingSurchargeModeValidator is a validator for the "billing_surcharge_mode" field. It is called by the builders before save.
	usagelog.BillingSurchargeModeValidator = usagelogDescBillingSurchargeMode.Validators[0].(func(string) error)
	// usagelogDescBillingSurchargeValue is the schema descriptor for billing_surcharge_value field.
	usagelogDescBillingSurchargeValue := usagelogFields[29].Descriptor()
	// usagelog.DefaultBillingSurchargeValue holds the default value on creation for the billing_surcharge_value field.
	usagelog.DefaultBillingSurchargeValue = usagelogDescBillingSurchargeValue.Default.(float64)
	...
	// userDescWithdrawableBalance is the schema descriptor for withdrawable_balance field.
	userDescWithdrawableBalance := userFields[5].Descriptor()
	// user.DefaultWithdrawableBalance holds the default value on creation for the withdrawable_balance field.
	user.DefaultWithdrawableBalance = userDescWithdrawableBalance.Default.(float64)
	// userDescWithdrawalFrozenBalance is the schema descriptor for withdrawal_frozen_balance field.
	userDescWithdrawalFrozenBalance := userFields[6].Descriptor()
	// user.DefaultWithdrawalFrozenBalance holds the default value on creation for the withdrawal_frozen_balance field.
	user.DefaultWithdrawalFrozenBalance = userDescWithdrawalFrozenBalance.Default.(float64)
	// userDescWithdrawalRecalcStatus is the schema descriptor for withdrawal_recalc_status field.
	userDescWithdrawalRecalcStatus := userFields[7].Descriptor()
	// user.DefaultWithdrawalRecalcStatus holds the default value on creation for the withdrawal_recalc_status field.
	user.DefaultWithdrawalRecalcStatus = userDescWithdrawalRecalcStatus.Default.(string)
	// user.WithdrawalRecalcStatusValidator is a validator for the "withdrawal_recalc_status" field. It is called by the builders before save.
	user.WithdrawalRecalcStatusValidator = userDescWithdrawalRecalcStatus.Validators[0].(func(string) error)
