...
func init() {
	...
	usagelogDescBillingSurchargeCost := usagelogFields[25].Descriptor()
	...
	usagelogDescBilledCost := usagelogFields[26].Descriptor()
	...
	usagelogDescBillingSurchargeMode := usagelogFields[27].Descriptor()
	...
	usagelogDescBillingSurchargeValue := usagelogFields[28].Descriptor()
