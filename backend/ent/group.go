...
type Group struct {
	...
	// 是否覆盖全局内部手续费配置
	BillingSurchargeOverrideEnabled bool `json:"billing_surcharge_override_enabled,omitempty"`
	// 是否启用分组内部手续费；仅影响实际扣款，不改变展示倍率
	BillingSurchargeEnabled bool `json:"billing_surcharge_enabled,omitempty"`
	// 内部手续费模式：none/percent_on_charged_cost/additive_multiplier
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldVideoModelPrices, group.FieldModelPricing, group.FieldModelRouting, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldReasoningEffortMappings:
			values[i] = new([]byte)
		case group.FieldBillingSurchargeOverrideEnabled, group.FieldBillingSurchargeEnabled, group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldAllowBatchImageGeneration, group.FieldImageRateIndependent, group.FieldVideoRateIndependent, group.FieldLongContextPricingEnabled, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldProfitControlEnabled:
			values[i] = new(sql.NullBool)
		case group.FieldRateMultiplier, group.FieldBillingSurchargeValue, group.FieldPeakRateMultiplier, group.FieldDailyLimitUsd, group.FieldWeeklyLimitUsd, group.FieldMonthlyLimitUsd, group.FieldImageRateMultiplier, group.FieldImagePrice1k, group.FieldImagePrice2k, group.FieldImagePrice4k, group.FieldBatchImageDiscountMultiplier, group.FieldBatchImageHoldMultiplier, group.FieldVideoRateMultiplier, group.FieldVideoPrice480p, group.FieldVideoPrice720p, group.FieldVideoPrice1080p, group.FieldWebSearchPricePerCall, group.FieldSearchPricePer1k, group.FieldAudioRealtimePricePerMin, group.FieldAudioTtsPricePerMillionChars, group.FieldAudioSttPricePerHour, group.FieldProfitMinMargin, group.FieldProfitSafetyBuffer:
			values[i] = new(sql.NullFloat64)
		case group.FieldID, group.FieldDefaultValidityDays, group.FieldFallbackGroupID, group.FieldFallbackGroupIDOnInvalidRequest, group.FieldSortOrder, group.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case group.FieldName, group.FieldDescription, group.FieldBillingSurchargeMode, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort:
	...
	for i := range columns {
		...
		case group.FieldBillingSurchargeOverrideEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field billing_surcharge_override_enabled", values[i])
			} else if value.Valid {
				_m.BillingSurchargeOverrideEnabled = value.Bool
			}
		case group.FieldBillingSurchargeEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field billing_surcharge_enabled", values[i])
			} else if value.Valid {
				_m.BillingSurchargeEnabled = value.Bool
			}
		case group.FieldBillingSurchargeMode:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field billing_surcharge_mode", values[i])
			} else if value.Valid {
				_m.BillingSurchargeMode = value.String
			}
		case group.FieldBillingSurchargeValue:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field billing_surcharge_value", values[i])
			} else if value.Valid {
				_m.BillingSurchargeValue = value.Float64
			}
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("billing_surcharge_override_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.BillingSurchargeOverrideEnabled))
	builder.WriteString(", ")
	builder.WriteString("billing_surcharge_enabled=")
	builder.WriteString(fmt.Sprintf("%v", _m.BillingSurchargeEnabled))
	builder.WriteString(", ")
	builder.WriteString("billing_surcharge_mode=")
	builder.WriteString(_m.BillingSurchargeMode)
	builder.WriteString(", ")
	builder.WriteString("billing_surcharge_value=")
	builder.WriteString(fmt.Sprintf("%v", _m.BillingSurchargeValue))
	builder.WriteString(", ")
