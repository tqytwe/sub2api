...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "billing_surcharge_override_enabled", Type: field.TypeBool, Default: false},
		{Name: "billing_surcharge_enabled", Type: field.TypeBool, Default: false},
		{Name: "billing_surcharge_mode", Type: field.TypeString, Size: 32, Default: "none"},
		{Name: "billing_surcharge_value", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(12,6)"}},
	...
	PaymentOrdersColumns = []*schema.Column{
		...
		{Name: "coupon_template_id", Type: field.TypeInt64, Nullable: true},
		{Name: "coupon_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
		{Name: "list_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		...
		{Name: "qualifying_recharge_amount", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		...
		{Name: "recharge_snapshot", Type: field.TypeJSON, Nullable: true, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "notes", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "batch_name", Type: field.TypeString, Nullable: true, Size: 120},
		{Name: "batch_tag", Type: field.TypeString, Nullable: true, Size: 120},
		{Name: "issued_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "issue_source", Type: field.TypeString, Nullable: true, Size: 40},
		{Name: "issue_ref", Type: field.TypeString, Nullable: true, Size: 200},
		{Name: "reward_pool_version", Type: field.TypeString, Nullable: true, Size: 80},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "validity_days", Type: field.TypeInt, Default: 30},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "used_by", Type: field.TypeInt64, Nullable: true},
		{Name: "issued_to", Type: field.TypeInt64, Nullable: true},
	}
	...
	RedeemCodesTable = &schema.Table{
		...
		ForeignKeys: []*schema.ForeignKey{
			...
			{
				Symbol:     "redeem_codes_users_issued_redeem_codes",
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "redeemcode_issued_to",
				Unique:  false,
				Columns: []*schema.Column{RedeemCodesColumns[18]},
			},
			{
				Name:    "redeemcode_batch_name_status",
				Unique:  false,
				Columns: []*schema.Column{RedeemCodesColumns[7], RedeemCodesColumns[4]},
			},
			{
	...
	SubscriptionEntitlementsColumns = []*schema.Column{
		...
		{Name: "quota_reserved_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "duration_hours", Type: field.TypeInt},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "pending"},
		{Name: "starts_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "activated_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "exhausted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	SubscriptionEntitlementsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "subscriptionentitlement_payment_order_id",
				Unique:  true,
				Columns: []*schema.Column{SubscriptionEntitlementsColumns[4]},
			},
			{
	...
	// SubscriptionEntitlementHoldsColumns holds the columns for the "subscription_entitlement_holds" table.
	SubscriptionEntitlementHoldsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "entitlement_id", Type: field.TypeInt64},
		{Name: "request_id", Type: field.TypeString, Size: 200},
		{Name: "request_fingerprint", Type: field.TypeString, Size: 128},
		{Name: "reserved_usd", Type: field.TypeFloat64, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "captured_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	// SubscriptionEntitlementHoldsTable holds the schema information for the "subscription_entitlement_holds" table.
	SubscriptionEntitlementHoldsTable = &schema.Table{
		Name:       "subscription_entitlement_holds",
		Columns:    SubscriptionEntitlementHoldsColumns,
		PrimaryKey: []*schema.Column{SubscriptionEntitlementHoldsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "subscriptionentitlementhold_entitlement_id_request_id",
				Unique:  true,
				Columns: []*schema.Column{SubscriptionEntitlementHoldsColumns[1], SubscriptionEntitlementHoldsColumns[2]},
			},
			{
				Name:    "subscriptionentitlementhold_entitlement_id_status",
				Unique:  false,
				Columns: []*schema.Column{SubscriptionEntitlementHoldsColumns[1], SubscriptionEntitlementHoldsColumns[6]},
			},
			{
				Name:    "subscriptionentitlementhold_expires_at",
				Unique:  false,
				Columns: []*schema.Column{SubscriptionEntitlementHoldsColumns[7]},
			},
		},
	}
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "quota_mode", Type: field.TypeString, Size: 24, Default: "recurring"},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "billing_surcharge_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	UsageLogsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "usagelog_subscription_entitlement_id",
				Unique:  false,
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "withdrawable_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "withdrawal_frozen_balance", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
		{Name: "withdrawal_recalc_status", Type: field.TypeString, Size: 24, Default: "needs_review"},
		{Name: "withdrawal_recalc_checked_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
	...
	Tables = []*schema.Table{
		...
		SubscriptionEntitlementHoldsTable,
...
func init() {
	...
	SubscriptionEntitlementHoldsTable.Annotation = &entsql.Annotation{
