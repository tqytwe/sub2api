...
type UserEdges struct {
	...
	// IssuedRedeemCodes holds the value of the issued_redeem_codes edge.
	IssuedRedeemCodes []*RedeemCode `json:"issued_redeem_codes,omitempty"`
...
// IssuedRedeemCodesOrErr returns the IssuedRedeemCodes value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) IssuedRedeemCodesOrErr() ([]*RedeemCode, error) {
	if e.loadedTypes[2] {
		return e.IssuedRedeemCodes, nil
	}
	return nil, &NotLoadedError{edge: "issued_redeem_codes"}
}
...
// QueryIssuedRedeemCodes queries the "issued_redeem_codes" edge of the User entity.
func (_m *User) QueryIssuedRedeemCodes() *RedeemCodeQuery {
	return NewUserClient(_m.config).QueryIssuedRedeemCodes(_m)
}
